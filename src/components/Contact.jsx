                    ...
                    <div className='flex items-start'>
                     ...
                     <div className='flex items-start'>
                        ...
                        <div>
                            ...
                            <p className='text-gray-400'>aarzoomohammad5@gmail.com</p>
                        </div>
                    </div>
                     <div className='flex items-start'>
                        <div className='text-purple text-2xl mr-4'>
                        ...
                        <div>
                            ...
                            <p className='text-gray-400'>+91 7534821315</p>
                        </div>
                    </div>
                    <div className='pt-4'>
                       <h3 className='text-lg font-semibold mb-4'>Follow Me</h3>
                       <div className='flex space-x-4'>
                         <a href="https://github.com/Aarzoomohd" className='w-12 h-12 rounded-full bg-dark-300
                         flex items-center justify-center text-purple hover:bg-purple
                         hover:text-white transition duration-300'>
                            <FaGithub/>
                         </a>
                          <a href="https://www.linkedin.com/in/aarzoo-mohd-a318b225b" className='w-12 h-12 rounded-full bg-dark-300
