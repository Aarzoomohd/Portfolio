...
const ProjectCard = ({image,tech,title,description,demo,code}) => {
  return (
     ...
     transition duration-300 cursor-pointer'>
        ...
        <div className='p-6'>
              ...
              <div className='flex gap-2'>
                        <a href={demo} className='flex-1 text-center px-4 py-2 bg-purple rounded-lg font-medium
                        hover:bg-purple-700 transition duration-300'>
                            View Demo
                        </a>
                        <a href={code} className='flex-1 text-center px-4 py-2 border 
