            ...
            <div className='flex flex-col md:flex-row items-center gap-12'>
                    ...
                    >
                        <div className='rounded-2xl p-8'>
                            <h3>My Journey</h3>  
                            <p className='text-gray-300 mb-6'>I'm a passionate full-stack developer with over 2 years of experience
                                creating digital solutions for bussinesses around the world.My journey started
                            ...
                            <p className='text-gray-300 mb-12'>When I'm not coding,you can find me exploring new 
                                technolgies,contributing to open-source projects, or 
                                sharing my knowledge through tech blogs and tutorials.
                                I believe in continuous learning and pushing the 
                                boundaries what's possible on the web.
                            </p>
